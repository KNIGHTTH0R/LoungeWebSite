...
global $wpdb;
global $wppa_error;
	if ( $wpdb->query($query) === false ) $wppa_error = true;
}
...
//						'wppa_ovl_close_txt'				=> 'Close',
						...
						'wppa_pause_symbol_url' 			=> wppa_get_imgdir( 'pause.png', 'abs' ),
						'wppa_stop_symbol_url' 				=> wppa_get_imgdir( 'stop.png', 'abs' ),
